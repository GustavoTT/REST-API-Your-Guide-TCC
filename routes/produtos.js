                ...
                produtos: result.map(prod => { // Modificando valor à retornar
                    return {
                        ...
                        type_request: {
                            ...
                            url: 'http://localhost:3000/produtos/' + prod.id_produto // URL individual do produto, ideal que seja var de ambiente
                        }
                    }
                })
            }
                        ...
                        const response = {
                            ...
                            produtoCriado: {
                                ...
                                type_request: {
                                    ...
                                    url: 'http://localhost:3000/produtos' // Ideal que seja var de ambiente
                                }
                            }
                        }
                        ...
                        const response = {
                            ...
                            produtoAtualizado: {
                                ...
                                type_request: {
                                    tipo: 'GET',
                                    descricao: 'Retorna os detalhes de um produto específico',
                                    url: 'http://localhost:3000/produtos/' + req.body.id_produto // URL individual do produto, ideal que seja var de ambiente
                                }
                            }
                        }
